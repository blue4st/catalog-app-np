...
colors:
  ...
  - name: Velvet Blue
    ...
    color: "#1a1a1a"
  - name: Baby Pink
    image: C15_baby-pink.webp
    color: "#1a1a1a"
  - name: Butter Cream
    image: C15_butter-cream.webp
    color: "#d2b48c"
  - name: Dark Brown
    image: C15_dark-brown.webp
    color: "#1a1a1a"
  - name: Forest Green
    image: C15_forest-green.webp
    color: "#1a1a1a"
  - name: Navy Blue
    image: C15_navy-blue.webp
    color: "#1a1a1a"
  - name: Steel Grey
    image: C15_steel-grey.webp
    color: "#f5f5f5"
  - name: Sunset Cream
    image: C15_sunset-cream.webp
    color: "#f5f5f5"
  - name: Kid Blue
    image: C15_kid-blue.webp
    color: "#1a1a1a"
  - name: Sky Blue
    image: C15_sky-blue.webp
    color: "#1a1a1a"
  - name: Sun Tan
    image: C15_sun-tan.webp
    color: "#1a1a1a"
  - name: Cute Peach
    image: C15_cute-peach.webp
    color: "#1a1a1a"
  - name: Retro Red
    image: C15_retro-red.webp
    color: "#1a1a1a"
  - name: Rust Orange
    image: C15_rust-orange.webp
    color: "#1a1a1a"
default_color: C15_dark-brown.webp
---
