...
colors:
  ...
  - name: Velvet Blue
    ...
    color: "#1a1a1a"
  - name: Baby Pink
    image: C02_baby-pink.webp
    color: "#1a1a1a"
  - name: Butter Cream
    image: C02_butter-cream.webp
    color: "#d2b48c"
  - name: Dark Brown
    image: C02_dark-brown.webp
    color: "#1a1a1a"
  - name: Forest Green
    image: C02_forest-green.webp
    color: "#1a1a1a"
  - name: Navy Blue
    image: C02_navy-blue.webp
    color: "#1a1a1a"
  - name: Steel Grey
    image: C02_steel-grey.webp
    color: "#f5f5f5"
  - name: Sunset Cream
    image: C02_sunset-cream.webp
    color: "#f5f5f5"
  - name: Kid Blue
    image: C02_kid-blue.webp
    color: "#1a1a1a"
  - name: Sky Blue
    image: C02_sky-blue.webp
    color: "#1a1a1a"
  - name: Sun Tan
    image: C02_sun-tan.webp
    color: "#1a1a1a"
  - name: Cute Peach
    image: C02_cute-peach.webp
    color: "#1a1a1a"
  - name: Retro Red
    image: C02_retro-red.webp
    color: "#1a1a1a"
  - name: Rust Orange
    image: C02_rust-orange.webp
    color: "#1a1a1a"
default_color: C02_navy-blue.webp
---
