...
colors:
  ...
  - name: Velvet Blue
    ...
    color: "#1a1a1a"
  - name: Baby Pink
    image: C21_baby-pink.webp
    color: "#1a1a1a"
  - name: Butter Cream
    image: C21_butter-cream.webp
    color: "#d2b48c"
  - name: Dark Brown
    image: C21_dark-brown.webp
    color: "#1a1a1a"
  - name: Forest Green
    image: C21_forest-green.webp
    color: "#1a1a1a"
  - name: Navy Blue
    image: C21_navy-blue.webp
    color: "#1a1a1a"
  - name: Steel Grey
    image: C21_steel-grey.webp
    color: "#f5f5f5"
  - name: Sunset Cream
    image: C21_sunset-cream.webp
    color: "#f5f5f5"
  - name: Kid Blue
    image: C21_kid-blue.webp
    color: "#1a1a1a"
  - name: Sky Blue
    image: C21_sky-blue.webp
    color: "#1a1a1a"
  - name: Sun Tan
    image: C21_sun-tan.webp
    color: "#1a1a1a"
  - name: Cute Peach
    image: C21_cute-peach.webp
    color: "#1a1a1a"
  - name: Retro Red
    image: C21_retro-red.webp
    color: "#1a1a1a"
default_color: C21_dark-knight.webp
---
